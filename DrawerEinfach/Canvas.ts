...
export class Canvas implements ShapeManager {
    ...
    constructor(canvasDomElement?: HTMLCanvasElement,
        ...
        function setupContextMenu ( self) {
            ...
            const menuItem1 = MenuApi . createRadioOption ("Hintergrundfarbe",
                { "rot": "#ff0000",
                         "gelb": "#ffff00",
                         "grün": "#008000",
                         "schwarz": "#000000",
            ...
            const menuItem3 = MenuApi . createRadioOption ("Randfarbe",
                {"rot": "#ff0000",
                    "gelb": "#ffff00",
                    "grün": "#008000",
                    "schwarz": "#000000",
    ...
    draw(): this {
        ...
        var ordered_shapes = Object.keys(this.shapes).sort((a, b) => { return this.shapes[a].zOrder - this.shapes[b].zOrder; }).reduce(
            (obj, id) => {
